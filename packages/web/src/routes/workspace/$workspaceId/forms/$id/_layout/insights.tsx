...
const funnelData = [
  { page: '1. Welcome', views: 8000, dropoff: 0, dropoffPercent: 0, avgTime: '12s' },
  { page: '2. Gender', views: 7500, dropoff: 500, dropoffPercent: 6, avgTime: '8s' },
  { page: '3. Age', views: 7200, dropoff: 300, dropoffPercent: 4, avgTime: '6s' },
  { page: '4. Lifestyle', views: 6900, dropoff: 300, dropoffPercent: 4, avgTime: '11s' },
  { page: '5. Goals', views: 6500, dropoff: 400, dropoffPercent: 6, avgTime: '15s' },
  { page: '6. Activity', views: 6100, dropoff: 400, dropoffPercent: 6, avgTime: '9s' },
  { page: '7. Diet', views: 5700, dropoff: 400, dropoffPercent: 7, avgTime: '14s' },
  { page: '8. Plan', views: 5200, dropoff: 500, dropoffPercent: 9, avgTime: '25s' },
  { page: '9. Paywall', views: 4600, dropoff: 600, dropoffPercent: 12, avgTime: '32s' },
]

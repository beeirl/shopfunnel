...
export function BinaryChoiceBlock(props: BinaryChoiceBlockProps) {
  return (
    <div className={cn(props.block.properties.label && '-mt-2')}>
      {props.block.properties.label && (
        <p className="mb-2 text-left text-sm font-medium">{props.block.properties.label}</p>
      )}
